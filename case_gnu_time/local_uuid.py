...
Its usage is intentionally awkward and two-stepped, to prevent accidental use in production environments.  configure() must be called, and the environment must contain the variable "DEMO_UUID_REQUESTING_NONRANDOM" with the value "NONRANDOM_REQUESTED".
"""
